...
const pageTitles: Record<string, { title: string; subtitle: string }> = {
  ...
  "/exam-simulations": {
    ...
    subtitle: "Evalúa tu dominio con V/F y preguntas de desarrollo",
  },
  "/categories": {
  ...
  if (isMobileViewport) {
    return (
      <div className="mb-shell">
        <header className="mb-shell-topbar" aria-label="Cabecera móvil">
          <div className="mb-breadcrumbs">
            <span className="mb-crumb-root">{mobileRootCrumb}</span>
            {showMobileCurrentCrumb && (
              <>
                <span className="mb-crumb-sep">/</span>
                <span className="mb-crumb-current">{mobileCurrentCrumb}</span>
              </>
            )}
          </div>
