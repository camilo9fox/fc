...
const Terms = () => {
  return (
    <TermsPoliciesTemplate
      ...
      description='Bienvenido a FlashyLab (en adelante, "la Aplicación"). Al registrarse, acceder o utilizar nuestra plataforma web o móvil, usted (en adelante, el "Usuario") acepta de manera expresa, voluntaria y sin reservas la totalidad de las cláusulas establecidas en este documento. Estos Términos y Condiciones constituyen un acuerdo legal vinculante entre el Usuario y los desarrolladores de FlashyLab. Si no está de acuerdo con alguna de las disposiciones aquí descritas, deberá abstenerse inmediatamente de utilizar la Aplicación.'
      date="Junio 2026"
      termsPoliciesList={[
        {
          id: "aceptacion",
          ...
          content: [
            "Al registrarse, acceder, descargar o utilizar FlashyLab, el Usuario acepta de manera expresa, voluntaria y sin reservas la totalidad de las cláusulas de este documento, así como cualquier modificación futura que sea debidamente notificada.",
            "Estos Términos y Condiciones constituyen un acuerdo legal vinculante entre el Usuario y los desarrolladores de FlashyLab. Se aplican a todas las interacciones con la Aplicación, incluyendo el acceso mediante navegador web, dispositivos móviles y cualquier otra plataforma compatible.",
        ...
        },
        {
          ...
          content: [
            "FlashyLab está diseñado para usuarios mayores de 13 años. Los menores de 13 años no están autorizados a crear una cuenta ni a utilizar la Aplicación sin el consentimiento y la supervisión directa de un padre, madre o tutor legal.",
        ...
        },
        {
          ...
          content: [
            ...
            "El funcionamiento óptimo de FlashyLab requiere que todo recurso de estudio creado se asocie y estructure bajo una Categoría principal definida por el Usuario antes de su ejecución. La Aplicación no se responsabiliza por la organización o clasificación del contenido que el Usuario decida crear.",
          ],
        },
        {
          id: "cuentas",
        ...
        },
        {
          ...
          content: [
            "El Usuario se compromete a utilizar FlashyLab exclusivamente para fines educativos lícitos, respetando en todo momento la legislación aplicable, los derechos de terceros y las normas de convivencia digital.",
            ...
            "El Usuario es el único responsable del contenido que introduce manualmente en la Aplicación. FlashyLab no realiza moderación previa del contenido generado por los usuarios, pero se reserva el derecho de eliminar cualquier material que infrinja estos Términos sin previo aviso.",
          ],
        },
        {
          ...
          content: [
            "FlashyLab integra modelos de lenguaje avanzados procesados a través de la API de Groq Cloud para automatizar la generación de recursos educativos tales como preguntas, opciones de respuesta, explicaciones y simulaciones de examen.",
        ...
        },
        {
          ...
          content: [
            "Con el propósito de mantener la estabilidad operativa y respetar los límites de cuota de la API de Groq, FlashyLab implementa un sistema automatizado de créditos de generación de contenido. Cada Usuario dispone de una cuota inicial de 30 créditos de estudio principales, que se renovarán automáticamente cada doce (12) horas.",
        ...
        },
        {
          ...
          content: [
            "FlashyLab mantiene un modelo de acceso gratuito financiado mediante la inclusión de anuncios publicitarios. Se integran redes como Google AdSense en el entorno web y, potencialmente, Google AdMob en entornos móviles.",
            "Los anuncios se desplegarán de forma programada basándose en la actividad del Usuario, activándose aproximadamente cada dos (2) sesiones de estudio finalizadas. El Usuario acepta que FlashyLab no ejerce control sobre el contenido de los anuncios ni sobre las políticas de recopilación de datos de los proveedores de publicidad de terceros.",
            "FlashyLab se reserva el derecho de ofrecer planes de suscripción premium libres de publicidad en el futuro. Dichos cambios serán comunicados con la debida antelación.",
          ],
        },
        {
          ...
          content: [
            "La estructura de software, diseño de interfaz, código fuente, logotipos, nombre y la marca FlashyLab son propiedad intelectual protegida de sus respectivos desarrolladores. Queda prohibida su reproducción, distribución o modificación sin autorización previa por escrito.",
            ...
            "Al ingresar contenido en la Aplicación, el Usuario otorga a FlashyLab una licencia gratuita, mundial, no exclusiva y estrictamente técnica para almacenar, procesar, transmitir y mostrar dicha información con el único fin de proveer las funciones del servicio solicitadas.",
          ],
        },
        {
          id: "enlaces-terceros",
          ...
          content: [
            "La Aplicación puede contener enlaces a sitios web o servicios de terceros que no son propiedad ni están controlados por FlashyLab. Estos enlaces se proporcionan únicamente para conveniencia del Usuario.",
            "FlashyLab no asume responsabilidad alguna por el contenido, las políticas de privacidad o las prácticas de los sitios web o servicios de terceros. El Usuario accede a dichos recursos bajo su propio riesgo y se recomienda revisar los términos y políticas de los mismos.",
          ],
        },
        {
          id: "terminacion",
          ...
          content: [
            "FlashyLab se reserva el derecho de suspender o cancelar la cuenta de cualquier Usuario en cualquier momento, con o sin causa y con o sin previo aviso, especialmente en casos de violación de estos Términos, conducta fraudulenta o actividad que pueda perjudicar la integridad de la plataforma.",
        ...
        },
        {
          ...
          content: [
            "FlashyLab se proporciona bajo el principio de tal cual (as is) y según disponibilidad (as available). No se otorga ninguna garantía, expresa o implícita, respecto al funcionamiento ininterrumpido, libre de errores o seguro de la Aplicación.",
        ...
        },
        {
          ...
          content: [
            "En la máxima medida permitida por las leyes aplicables, FlashyLab y sus desarrolladores no serán responsables por daños directos, indirectos, incidentales, especiales, punitivos o consecuentes derivados del uso o la imposibilidad de uso de la Aplicación.",
            ...
            "La responsabilidad total de FlashyLab ante cualquier reclamación relacionada con el servicio no excederá, en ningún caso, la cantidad pagada por el Usuario a FlashyLab durante los doce (12) meses anteriores al evento que dio lugar a la reclamación.",
          ],
        },
        {
          id: "indemnizacion",
        ...
        },
        {
          ...
          content: [
            "FlashyLab se reserva el derecho de actualizar, corregir o reformular estos Términos y Condiciones en cualquier momento para adaptarlos a cambios legales, comerciales o técnicos. Las modificaciones entrarán en vigor en el momento de su publicación en la Aplicación.",
            "El uso continuo de FlashyLab tras la publicación de cualquier enmienda constituirá la aceptación plena de los nuevos Términos. Se recomienda al Usuario revisar periódicamente este documento para estar al tanto de las actualizaciones.",
            "En caso de modificaciones sustanciales, FlashyLab realizará esfuerzos razonables para notificar a los usuarios a través de la interfaz de la Aplicación o mediante comunicación electrónica.",
          ],
        },
        {
          id: "contacto",
          ...
          content: [
            "Para consultas, reclamaciones o solicitudes de información relacionadas con estos Términos y Condiciones, el Usuario puede contactar al equipo de FlashyLab a través de los canales de soporte oficiales disponibles en la sección de Ayuda de la Aplicación o mediante la funcionalidad de tickets de soporte.",
          ],
        },
      ]}
    />
