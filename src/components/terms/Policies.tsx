      ...
      termsPoliciesList={[
        {
          ...
          content: [
            ...
            "El tratamiento de los datos se realiza con el único propósito de proveer, personalizar, optimizar y asegurar el correcto funcionamiento del servicio de asistencia al estudio ofrecido por Flashy.",
          ],
        },
        {
        ...
        },
        {
          ...
          content: [
            ...
            "Las contraseñas de acceso son sometidas a un proceso de hash y salting del lado del servidor mediante los protocolos estándar de seguridad de Supabase, impidiendo que los desarrolladores de Flashy o terceros no autorizados tengan acceso directo a las credenciales en texto plano.",
            "Supabase aplica medidas de seguridad a nivel de infraestructura que incluyen cifrado de datos en reposo, cifrado en tránsito mediante TLS, controles de acceso basados en roles y firewalls de red. Sin embargo, Flashy no puede garantizar la inviolabilidad absoluta de los sistemas de terceros.",
          ],
        },
        {
          id: "groq-ia",
          ...
          content: [
            ...
            "Flashy no almacena copias permanentes de las solicitudes enviadas a Groq más allá de lo necesario para entregar el resultado al Usuario. No obstante, el Usuario debe ser consciente de que la naturaleza del procesamiento en la nube implica la transmisión de datos fuera del entorno controlado de Flashy.",
        ...
        },
        {
          ...
          content: [
            "Flashy utiliza cookies propias esenciales para el funcionamiento técnico de la plataforma, tales como el mantenimiento de sesiones de usuario, la persistencia de preferencias de tema (claro u oscuro) y la configuración de idioma de la interfaz.",
            ...
            "Como parte del modelo de financiación gratuita, Flashy integra redes de publicidad de terceros (actualmente Google AdSense en la versión web y potencialmente Google AdMob en dispositivos móviles). Estos proveedores pueden utilizar cookies, identificadores de dispositivo y tecnologías de rastreo para mostrar anuncios personalizados.",
        ...
        },
        {
          ...
          content: [
            "Flashy conserva los datos personales del Usuario y su progreso de estudio únicamente mientras la cuenta permanezca activa en la plataforma. Los datos de uso y actividad se conservan con fines estadísticos internos mientras la cuenta esté activa.",
            ...
            "Los datos transmitidos a la API de Groq durante las sesiones de generación no son retenidos por Flashy tras la entrega del resultado al Usuario, aunque pueden persistir temporalmente en los registros operativos de Groq conforme a sus propias políticas de retención.",
          ],
        },
        {
          id: "derechos-usuario",
          ...
          content: [
            ...
            "Derecho de acceso: el Usuario puede solicitar en cualquier momento un informe detallado sobre los datos personales que Flashy ha recopilado y almacenado en relación con su cuenta.",
        ...
        },
        {
          ...
          content: [
            "Flashy no recopila ni solicita intencionadamente información personal de niños menores de 13 años. Si se detecta que un menor de 13 años ha proporcionado datos personales sin el consentimiento verificable de sus padres o tutores, dichos datos serán eliminados de inmediato.",
            ...
            "Los padres o tutores que tengan conocimiento de que un menor a su cargo ha proporcionado datos personales sin su consentimiento pueden contactar al equipo de Flashy a través de los canales de soporte para solicitar la eliminación inmediata de dicha información.",
          ],
        },
        {
          id: "transferencias",
          ...
          content: [
            ...
            "Flashy se compromete a garantizar que dichas transferencias internacionales cuenten con las salvaguardas adecuadas y se realicen únicamente a países que ofrezcan un nivel de protección de datos equiparable al exigido por la legislación aplicable en el país de origen del Usuario.",
          ],
        },
        {
          ...
          content: [
            "En caso de producirse una violación de seguridad que comprometa los datos personales de los usuarios, Flashy se compromete a notificar a los usuarios afectados y a las autoridades de protección de datos competentes en un plazo máximo de setenta y dos (72) horas desde la confirmación del incidente.",
        ...
        },
        {
          ...
          content: [
            "Flashy implementa y mantiene medidas de seguridad técnicas y organizativas estándar en la industria, incluyendo pero no limitándose a: cifrado de comunicaciones mediante HTTPS y TLS, almacenamiento de contraseñas con hash y salting, controles de acceso basados en roles y monitoreo continuo de actividad sospechosa.",
            "A pesar de estas medidas, el Usuario debe ser consciente de que ningún método de transmisión por Internet o de almacenamiento electrónico es absolutamente seguro. Flashy no puede garantizar la invulnerabilidad total frente a ataques informáticos sofisticados, filtraciones de datos derivadas de brechas en infraestructura de terceros o accesos no autorizados que escapen a controles técnicos razonables.",
          ],
        },
        {
          id: "cambios",
          ...
          content: [
            ...
            "El uso continuado de los servicios de Flashy tras la publicación de los cambios constituye la aceptación y el consentimiento del Usuario hacia los nuevos términos de privacidad. Se recomienda revisar periódicamente esta página.",
          ],
        },
        {
          id: "contacto",
          ...
          content: [
            "Para cualquier consulta, solicitud de ejercicio de derechos, reporte de incidentes de seguridad o preguntas relacionadas con esta Política de Privacidad, el Usuario puede contactar al equipo de Flashy a través de la funcionalidad de tickets de soporte disponible en la sección de Ayuda de la Aplicación.",
          ],
        },
      ]}
    />
