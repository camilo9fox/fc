...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="prf-page">
      ...
      {/* Legal */}
      <section className="prf-section">
        <h3 className="prf-section-title">Legal</h3>
        <div className="prf-cards">
          <Link to="/terms" className="prf-card prf-card-link">
            <div className="prf-card-icon prf-icon-terms">
              <svg
                width="26"
                height="26"
                viewBox="0 0 24 24"
            ...
            <div className="prf-card-body">
              <p className="prf-card-title">Términos y condiciones</p>
              <p className="prf-card-desc">
                Revisa los términos de uso de la plataforma.
              </p>
            </div>
            <div className="prf-card-arrow">
              <svg
          ...
          <Link to="/policies" className="prf-card prf-card-link">
            <div className="prf-card-icon prf-icon-privacy">
              <svg
                width="26"
                height="26"
                viewBox="0 0 24 24"
            ...
            <div className="prf-card-body">
              <p className="prf-card-title">Políticas de privacidad</p>
              <p className="prf-card-desc">
