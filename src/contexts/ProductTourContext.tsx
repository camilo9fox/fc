...
export const TOUR_STEPS_MOBILE: TourStep[] = [
  { targetId: "nav-mobile-home", title: "Panel de progreso", description: "Aquí ves tu actividad diaria, tarjetas pendientes y acceso rápido a tus recursos.", path: "/m/home" },
  ...
  { targetId: "nav-mobile-library", title: "Tu biblioteca", description: "Gestiona tus recursos privados o explora temas públicos de la comunidad.", path: "/m/library" },
